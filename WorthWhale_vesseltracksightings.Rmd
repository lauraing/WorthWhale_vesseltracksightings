...
filename <- "whalesightings.sqlite"
whalesightings <- dbConnect(RSQLite::SQLite(), filename)
dbWriteTable(whalesightings, "whalesightings2005_2018", whalesightings2005_2018)

```

wait till the end to create some code to append the table in the database
